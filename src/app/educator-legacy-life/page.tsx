...
export default function EducatorLegacyLifePage() {
  ...
  const brand = getBrandById('educator-legacy-life');
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="text-center space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl font-bold text-gray-900 leading-tight">
                <span className="text-green-600">Secure the future</span><br />
                <span className="text-gray-800">you've been shaping.</span>
              </h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                You've dedicated your life to teaching others. Now we'll help you protect 
                your own legacy with life insurance designed for educators.
              </p>
              <div className="flex items-center justify-center space-x-4 text-sm text-gray-500">
                <div className="flex items-center">
                  <Star className="h-4 w-4 text-green-500 mr-1" />
                  <span>Trusted by 40,000+ Educators</span>
                </div>
                <div className="flex items-center">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-12">
            Protection Plans for Teachers & Educators
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-6">Lifetime protection with guaranteed cash value that grows with your career.</p>
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-6">Affordable coverage during your teaching years with conversion options.</p>
                <ul className="space-y-2 text-left">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500" />
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="pt-8">
                <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <ChartLine className="h-8 w-8 text-emerald-600" />
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-12">
            Educator Insurance vs Traditional Options... What's the difference?
          </h2>
            ...
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                ...
                <tr className="bg-gray-50">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">School Year Planning</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-gray-600">Limited</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-green-600 font-semibold">✓ Academic Calendar</td>
                </tr>
                <tr className="bg-white">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Union Member Benefits</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-gray-600">None</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-green-600 font-semibold">✓ Union Discounts</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Education Expert Support</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-gray-600">Generic</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-green-600 font-semibold">✓ Education Specialists</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-16 bg-green-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            Join thousands of educators who've already secured their future and started building generational wealth through our educator-focused life insurance plans.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              onClick={() => setShowComprehensiveFunnel(true)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Securing the future you've been shaping since 2024.
              </p>
            </div>
            <div>
