...
import { ArrowRight, Phone, Wrench, CheckCircle, Star, Award, Shield, Clock, ChartLine, Zap, Cog, Settings } from 'lucide-react';

export default function TradeLegacyLifePage() {
  const { openModal } = useFunnelStore();
  const [showTradeFunnel, setShowTradeFunnel] = useState(false);
  const brandConfig = getBrandConfig('trade-legacy-life');
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <span className="text-2xl font-bold text-gray-900" style={{
                ...
                textShadow: '0 2px 8px rgba(234,88,12,0.07)',
      ...
      <section 
        ...
        onClick={() => setShowTradeFunnel(true)}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl font-bold text-gray-900 leading-tight">
                <span className="text-orange-600">Master your trade.</span><br />
                <span className="text-gray-800">Secure your future.</span>
              </h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Skilled tradespeople deserve skilled protection. Our trade-focused life insurance plans understand your unique needs and provide the security your family deserves.
              </p>
              <div className="flex items-center justify-center space-x-4 text-sm text-gray-500">
                <div className="flex items-center">
                  <Star className="h-4 w-4 text-orange-500 mr-1" />
                  <span>Trusted by 30,000+ Tradespeople</span>
                </div>
                <div className="flex items-center">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-12">
            Protection Plans for Skilled Tradespeople
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-6">Lifetime protection with guaranteed cash value that grows with your trade.</p>
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-6">Affordable coverage during your trade's early years with conversion options.</p>
                <ul className="space-y-2 text-left">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-orange-500" />
            ...
            <table className="w-full border-collapse border border-gray-300">
              <thead>
                <tr className="bg-orange-600 text-white">
                  ...
                  <th className="border border-gray-300 px-6 py-4 text-center bg-orange-700">Trade Legacy Life</th>
                </tr>
              </thead>
              <tbody>
                <tr className="bg-white">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Trade-Specific Planning</td>
                ...
                <tr className="bg-gray-50">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Apprenticeship Support</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-gray-600">Limited</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-orange-600 font-semibold">✓ Comprehensive</td>
                </tr>
                <tr className="bg-white">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Tool & Equipment</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-gray-600">Basic</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-orange-600 font-semibold">✓ Advanced</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Trade Support</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-gray-600">Generic</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-orange-600 font-semibold">✓ Expert Guidance</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-16 bg-orange-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            Ready to Protect Your Trade's Future?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Protecting skilled trades since 2024.
              </p>
            </div>
            <div>
      ...
      {showTradeFunnel && brandConfig && (
        <DynamicFunnel
          brandConfig={brandConfig}
          onComplete={handleFunnelComplete}
          onClose={() => setShowTradeFunnel(false)}
        />
      )}
    </div>
  );
