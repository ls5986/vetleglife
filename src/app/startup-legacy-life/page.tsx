...
import { ArrowRight, Phone, Rocket, CheckCircle, Star, Award, Shield, Clock, ChartLine, Zap } from 'lucide-react';

export default function StartupLegacyLifePage() {
  const { openModal } = useFunnelStore();
  const [showStartupFunnel, setShowStartupFunnel] = useState(false);
  const brandConfig = getBrandConfig('startup-legacy-life');
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section 
        ...
        onClick={() => setShowStartupFunnel(true)}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                You take risks every day building your company — your financial future doesn't need to be one of them. Lock in lifelong protection and a wealth-building plan that grows with your startup.
              </p>
              <div className="flex items-center justify-center space-x-4 text-sm text-gray-500">
                <div className="flex items-center">
                  <Star className="h-4 w-4 text-green-500 mr-1" />
                  <span>Trusted by 20,000+ Entrepreneurs</span>
                </div>
                <div className="flex items-center">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-12">
            Protection Plans for Entrepreneurs & Startup Founders
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 mb-6">Affordable coverage during your startup's early years with conversion options.</p>
                <ul className="space-y-2 text-left">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500" />
            ...
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                <tr className="bg-white">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Startup-Specific Planning</td>
                ...
                <tr className="bg-gray-50">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Funding Round Support</td>
                ...
                <tr className="bg-white">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Equity Compensation</td>
                ...
                <tr className="bg-gray-50">
                  <td className="border border-gray-300 px-6 py-4 font-semibold">Entrepreneur Support</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-gray-600">Generic</td>
                  <td className="border border-gray-300 px-6 py-4 text-center text-green-600 font-semibold">✓ Expert Guidance</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-16 bg-green-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
            Join thousands of entrepreneurs who've already secured their families and built wealth through our startup-focused life insurance plans.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              onClick={() => setShowStartupFunnel(true)}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Protecting startup dreams since 2024.
              </p>
            </div>
            <div>
              ...
              <div className="space-y-2 text-gray-400">
                <p>(555) 123-4568</p>
                <p>info@startuplegacylife.com</p>
              </div>
            </div>
            <div>
      ...
      {showStartupFunnel && brandConfig && (
        <DynamicFunnel
          brandConfig={brandConfig}
          onComplete={handleFunnelComplete}
          onClose={() => setShowStartupFunnel(false)}
        />
      )}
    </div>
  );
